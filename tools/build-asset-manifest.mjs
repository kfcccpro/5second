...
const version='maintenance-v1.4.0';
const outName='asset-integrity-manifest-maintenance-v1.json';
const critical=new Set([
  'index.html','maintenance-v1.css','maintenance-v1.2-landscape.css','maintenance-v1.3-workspace.css','maintenance-v1.3-state.css','maintenance-v1.4-simple.css','rc-core.css','phase31-core.css','manifest.webmanifest',
